...
<div className="flex flex-row items-center mt-5 animate-slide-from-left">
  ...
  <div className="ml-9 flex flex-col w-[50rem] items-start gap-0 px-10 pt-3 pb-0 relative bg-[#ffe8a31a] rounded-2xl">
    <div className="inline-flex items-start relative flex-[0_0_auto]">
      <div className="font-meth relative w-fit [font-family:'Montserrat-Regular',Helvetica] font-bold text-white text-[1.3rem] tracking-[0.05rem] leading-[normal] whitespace-nowrap">
        Achievements
      </div>
    </div>
