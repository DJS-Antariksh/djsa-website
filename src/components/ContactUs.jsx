    ...
    <form className="max-w-3xl p-8 mx-auto">
      <div className="grid grid-cols-2 gap-4">
        <div className="flex flex-col mb-4">
          <label className="block mb-4 text-sm text-white text-gray-700 font-poppins" htmlFor="name">
            Company Name
          </label>
          <input
        ...
        <div className="flex flex-col mb-4 ">
          <label className="block mb-4 text-sm text-white text-gray-700 font-poppins ml-14" htmlFor="email">
            Email
          </label>
          <input
        ...
        <div className="flex flex-col mb-10">
          <label className="block mb-4 text-sm text-white text-gray-700 font-poppins" htmlFor="nationality">
            Nationality
          </label>
          <input
            className="w-full px-3 py-2 text-white bg-transparent border border-white border-opacity-40 focus:border-white"
        ...
        <div className="flex flex-col mb-4">
          <label className="block mb-4 text-sm text-white text-gray-700 font-poppins ml-14" htmlFor="phone">
            Phone Number
          </label>
          <input
            className="w-full px-3 py-2 text-white bg-transparent border border-white border-opacity-40 ml-14 focus:border-white"
      ...
      <div className="mb-4">
        <label className="block mb-4 text-sm text-white text-gray-700 font-poppins" htmlFor="message">
          Message
        </label>
        <textarea
