...
import logo from "../assets/djsaLogo.png";
...
const Footer = () => (
  ...
  <img
          src={bg}
            alt="footerbg"
            className="w-full h-max absolute object-contain z-0"
            />
  <section
    className="flex justify-center items-center sm:py-16 py-6 flex-col z-99">
