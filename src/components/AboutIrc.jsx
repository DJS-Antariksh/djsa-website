...
const AboutIrc = () => {
  return (
    <div className='flex flex-col gap-3 justify-center items-center'>
        <div className='text-white font-meth text-4xl tracking-widest -mt-[13%] mb-4 font-bold'>ABOUT IRC 2025</div>

        <div className='text-white font-poppins w-[80%] text-xl leading-relaxed text-justify'>
